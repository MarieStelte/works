...
const ProjectCard = ({
  ...
  <div
    className={`w-full ${isReversed ? "lg:flex-row-reverse" : "lg:flex-row"} flex flex-col gap-8 lg:gap-16 items-start mb-16 lg:mb-24`}
  >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-4xl">
            <p className="font-inter text-[25px] leading-[52px] text-portfolio-text">
              Marie is an integrated designer working as a visual designer with
              a strong focus on visual communication and corporate identity.
              Through her education and practical experiences, she has developed
              a holistic understanding of design as an interdisciplinary
              approach to problem-solving, where boundaries between disciplines
              are fluid and complementary.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="border-t border-portfolio-border pt-8">
            <div className="flex justify-between items-start mb-8">
              <h3 className="font-inter text-[25px] font-normal leading-[36px] tracking-[-0.36px] text-portfolio-text">
                person
              </h3>
            </div>
            <div className="grid lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-6 lg:col-start-5">
                <p className="font-inter text-[20px] font-normal leading-[30px] tracking-[-0.27px] text-portfolio-text">
                  Marie Stelte is a Cologne-based integrated designer. She holds
                  a B.A. in Integrated Design from the Bauhaus Dessau. She works
                  full-time as a Visual Designer in a marketing team and also
                  takes on freelance design projects.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-12 gap-8">
              <div className="lg:col-span-6 lg:col-start-5">
                <div className="font-inter text-[20px] font-normal leading-[30px] tracking-[-0.27px] text-portfolio-text space-y-4">
                  <p>
                    <span className="font-bold">2014 – 2016</span> B.A. in Wood
                    Engineering, HNE University of Applied Sciences, Eberswalde
                  </p>
                  <p>
                    <span className="font-bold">2017 – 2021</span> B.A. in
                    Integrated Design Anhalt University of Applied Sciences,
                    Dessau
                  </p>
                  <p>
                    <span className="font-bold">2019 – 2020</span> Erasmus
                    Semester in Fine Arts University of the Arts Poznań, Poland
                  </p>
                  <p>
                    <span className="font-bold">2021</span> Certified Training
                    in Online Marketing Google Zukunftswerkstatt
                  </p>
                  <p>
                    <span className="font-bold">2022</span> Advanced Training in
                    Design Thinking, ARD.ZDF Media Academy, Cologne
                  </p>
                  <p>
                    <span className="font-bold">2022</span> Advanced Training in
                    Argumentation and Discussion Techniques, ARD.ZDF Media
                    Academy, Cologne
                  </p>
                </div>
              </div>
          ...
          <div className="border-t border-portfolio-border pt-8">
            <div className="flex justify-between items-start mb-8">
              <h3 className="font-montserrat text-[25px] font-normal leading-[36px] tracking-[-0.36px] text-portfolio-text">
                <span className="font-inter">Work</span>
              </h3>
            </div>
            <div className="grid lg:grid-cols-12 gap-8">
              <div className="lg:col-span-6 lg:col-start-5">
                <div className="font-inter text-[20px] font-normal leading-[30px] tracking-[-0.27px] text-portfolio-text space-y-4">
                  <p>
                    <span className="font-bold">2018</span> Student Assistant to
                    Prof. Brigitte Hartwig, Anhalt University of Applied
                    Sciences, Dessau
                  </p>
                  <p>
                    <span className="font-bold">2010 – 2021</span> Archiving and
                    Digitizing the Negative Collection of Photographer Harald
                    Hauswald, Berlin
                  </p>
                  <p>
                    <span className="font-bold">since 2020</span> Freelance
                    Designer
                  </p>
                  <p>
                    <span className="font-bold">2021 – 2022</span> Traineeship
                    in On-Air Design, Westdeutscher Rundfunk (WDR), Cologne
                  </p>
                  <p>
                    <span className="font-bold">since 2022</span> Visual
                    Designer at CONTACT Software, Cologne
                  </p>
                </div>
              </div>
            </div>
