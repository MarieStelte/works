          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-16">
            <div className="lg:col-span-5">
              ...
              <p className="body-medium text-portfolio-text-muted leading-relaxed">
                Selected projects from my role as a full-time Visual Designer at CONTACT Software. 
                The work spans 3D visuals for trade fair communication (Hannover Messe 2023), 
                editorial layouts for corporate reports, and animated product teasers. Each project 
                reflects applied design within an established corporate identity system, with a focus 
                on precision, consistency, and cross-media usability.
              </p>
            </div>
            <div className="lg:col-span-7">
              <div className="w-full aspect-[2/1]">
                <img 
                  src="https://api.builder.io/api/v1/image/assets/TEMP/85c8adfd2ce9373430c813020daca527ced280ac?width=1902"
                  alt="CONTACT Software Professional Work"
