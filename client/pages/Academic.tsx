          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-16">
            <div className="lg:col-span-5">
              ...
              <p className="body-medium text-portfolio-text-muted leading-relaxed">
                Spagat, a podcast format and corporate design addressing taboo
                topics through inclusive communication. The concept combines
                gender-sensitive branding, a community-based content strategy
                via Instagram, and user-centered research to create an open
                space for experiences often left unspoken.
              </p>
            </div>
