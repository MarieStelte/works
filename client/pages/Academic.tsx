          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-16">
            <div className="lg:col-span-5">
              ...
              <p className="body-medium text-portfolio-text-muted leading-relaxed">
                Spagat, a podcast format and corporate design addressing taboo topics through 
                inclusive communication. The concept combines gender-sensitive branding, a 
                community-based content strategy via Instagram, and user-centered research to 
                create an open space for experiences often left unspoken.
              </p>
            </div>
            <div className="lg:col-span-7">
              <div className="w-full aspect-[3/2]">
                <img 
                  src="https://api.builder.io/api/v1/image/assets/TEMP/61bafb67540ff29581fb09eedc1e7e578d9493b4?width=2562"
                  alt="Spagat Podcast Academic Project"
