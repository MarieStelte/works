          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-16">
            <div className="lg:col-span-5">
              ...
              <p className="body-medium text-portfolio-text-muted leading-relaxed">
                Visual identities for WDR aktuell, MoMa, and Samstagskolumne
                (now Impuls), including logos, social templates, and an icon set
                to ensure brand consistency across platforms.
              </p>
            </div>
