          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-16">
            <div className="lg:col-span-5">
              ...
              <p className="body-medium text-portfolio-text-muted leading-relaxed">
                Brand identity for Stelte Schmuck, including logo design, corporate design, 
                and social media presence. Additional freelance projects encompassed diverse 
                print and digital media, focusing on addressing individual brand identities 
                and delivering tailored solutions for clients.
              </p>
            </div>
